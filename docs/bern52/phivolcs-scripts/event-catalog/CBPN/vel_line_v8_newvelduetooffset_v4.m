...
for k=1:1:num_file
    ...
    for kk=1:1:offN+1
        ...
        he=subplot(3,1,1);
        hold on
        plot(d(O(kk,1):O(kk,2),1),d(O(kk,1):O(kk,2),2),'o', 'MarkerSize', 5, 'MarkerEdgeColor', '#003399');
        ...
        hn=subplot(3,1,2);
        hold on
        plot(d(O(kk,1):O(kk,2),1),d(O(kk,1):O(kk,2),3),'o', 'MarkerSize', 5, 'MarkerEdgeColor', '#003399');
        ...
        hu=subplot(3,1,3);
        hold on
        plot(d(O(kk,1):O(kk,2),1),d(O(kk,1):O(kk,2),4),'o', 'MarkerSize', 5, 'MarkerEdgeColor', '#003399');
