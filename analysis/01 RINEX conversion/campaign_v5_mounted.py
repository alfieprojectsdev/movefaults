import os, glob, math
print('Running: campv5_mounted.exe')
print('---------------------------------------------------------------------------')
        ...
        while code == 1:
            ...
            if teqc == 'EXIT':
                ...
                if ask == '1':
                    ...
                    at = 'TRM115000.00'
                pe = float(input('    Average height: '))
                os.system('teqc -tr d -O.dec 30 -phc -O.mo "' + mo + '" -O.at ' + at + ' -O.pe ' + ("%.4f" %pe) + ' 0 0 +C2 +obs + -tbin 1d ' + mo+' '+teqc) #added +C2 on 12.09.2020
