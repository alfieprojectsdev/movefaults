...
for k=1:1:num_file
    ...
    t=datetime(rawdata.textdata(:,1),'InputFormat','yyyy-MM-dd HH:mm:ss');
	...
	d=d*100;  %m--> cm
    N=length(t);
    eq=datetime('2022-07-27 00:43:24','InputFormat','yyyy-MM-dd HH:mm:ss'); %EDIT THIS
    ...
    hu.YAxis.FontSize=7;
    grid minor;
    xlabel('GPS time of DOY 207-208'); %EDIT THIS
    % set(gca,'XTickLabelRotation',60);
